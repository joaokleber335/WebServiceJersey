...
public class ProdutoREST {
	 ...
	 * 
	 * Produto - Código - Nome - Unidade Medida - NCM - Valor Compra - Valor Venda
	 * 
	 * Pessoa - Código - Nome - Data Nascimento - Sexo
	 * 
	 * 
	 * Observação: Realizar o deploy do projeto no tomcat instalado em seu
